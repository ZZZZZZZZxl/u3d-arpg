...
该项目是一个基于 **Unity 2022** 开发的第三人称 3D ARPG 动作战斗 Demo，主要用于展示个人在 **Unity 游戏客户端 / Gameplay 开发** 方向上的工程能力与玩法系统设计能力。

项目当前聚焦于动作战斗原型验证，重点覆盖了 **角色移动、连招战斗、动画驱动位移、敌人 AI、导航追击、相机跟随、数据驱动配置** 等核心模块。
...
本项目中的 **角色模型、动作、美术贴图、场景资源、音视频素材等演示资源均来自网络公开素材**，仅用于 **学习、技术研究与个人求职作品展示**，**不用于任何商业用途**。
